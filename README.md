...
> This is a web-based game built with JavaScript and phaser.js, the game consists of a number of features and options and it is a single-player game, Check out 
> the live link and have fun:smiley:
